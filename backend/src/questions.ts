export const questions = [
  ...
  { id: "attu_1", category: "TTU", image: "/images/ttu.png", question: "Đại học Tân Tạo được thành lập vào năm nào?", options: [{ id: "A", text: "2008", isCorrect: false }, { id: "B", text: "2010", isCorrect: true }, { id: "C", text: "2012", isCorrect: false }, { id: "D", text: "2015", isCorrect: false }], timeLimit: 10 },
  { id: "attu_2", category: "TTU", image: "/images/ttu.png", question: "Ai là người sáng lập Đại học Tân Tạo?", options: [{ id: "A", text: "GS. TS. Đặng Thị Hoàng Yến", isCorrect: true }, { id: "B", text: "Bà Nguyễn Phương Thảo", isCorrect: false }, { id: "C", text: "Ông Phạm Nhật Vượng", isCorrect: false }, { id: "D", text: "Bà Thái Hương", isCorrect: false }], timeLimit: 10 },
  { id: "attu_3", category: "TTU", image: "/images/ttu.png", question: "Biểu tượng nổi bật của TTU là gì?", options: [{ id: "A", text: "Toà nhà hình chiếc lá", isCorrect: false }, { id: "B", text: "Toà nhà Gillis", isCorrect: true }, { id: "C", text: "Tháp tri thức", isCorrect: false }, { id: "D", text: "Hồ bơi vô cực", isCorrect: false }], timeLimit: 10 },
  { id: "attu_4", category: "TTU", image: "/images/ttu.png", question: "Triết lý giáo dục của TTU nhấn mạnh yếu tố nào?", options: [{ id: "A", text: "Học đi đôi với hành", isCorrect: false }, { id: "B", text: "Khai phóng và Học suốt đời", isCorrect: true }, { id: "C", text: "Đề cao lý thuyết", isCorrect: false }, { id: "D", text: "Tự do tuyệt đối", isCorrect: false }], timeLimit: 10 },

  // Chủ đề: Khoa Công Nghệ Thông Tin
  { id: "it_1", category: "IT", image: "/images/it.png", question: "Khoa Công nghệ Thông tin hiện nay đào tạo mấy chuyên ngành cử nhân?", options: [{ id: "A", text: "4", isCorrect: true }, { id: "B", text: "3", isCorrect: false }, { id: "C", text: "2", isCorrect: false }, { id: "D", text: "1", isCorrect: false }], timeLimit: 10 },
  { id: "it_2", category: "IT", image: "/images/it.png", question: "Tiền thân Khoa CNTT có tên là gì?", options: [{ id: "A", text: "Khoa Máy tính", isCorrect: false }, { id: "B", text: "Khoa Kỹ thuật", isCorrect: true }, { id: "C", text: "Công nghệ", isCorrect: false }, { id: "D", text: "Khoa Trí tuệ Nhân tạo", isCorrect: false }], timeLimit: 10 },
  {
    id: "it_3_v2",
